...
Original file is located at
    https://colab.research.google.com/drive/1GkMTBWPsvB9p8yacETPvdkliXAnVB9LI
"""
...
def solution_B5():
    ...
    with open('daily-max-temperatures.csv') as csvfile:
        ...
        for row in reader:
            ...
            time_step.append(int(step))  # YOUR CODE HERE)
            step=step + 1
    ...
    model=tf.keras.models.Sequential([
        # YOUR CODE HERE.
        tf.keras.layers.Conv1D(filters=128, kernel_size=3, strides=1, padding="causal",input_shape=[None, 1],activation="relu"),
